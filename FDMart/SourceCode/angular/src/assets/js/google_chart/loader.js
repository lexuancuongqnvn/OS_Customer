(function() {
    ...
    */
    ...
    J.m.N = {
        ia: {
            "gstatic.com": {
                loader: H("https://www.gstatic.com/charts/51/loader.js"),
                debug: H("https://www.gstatic.com/charts/debug/51/js/jsapi_debug_%{package}_module.js"),
                debug_i18n: H("https://www.gstatic.com/charts/debug/51/i18n/jsapi_debug_i18n_%{package}_module__%{language}.js"),
                compiled: H("https://www.gstatic.com/charts/51/js/jsapi_compiled_%{package}_module.js"),
                compiled_i18n: H("https://www.gstatic.com/charts/51/i18n/jsapi_compiled_i18n_%{package}_module__%{language}.js"),
                css: H("https://www.gstatic.com/charts/51/css/%{subdir}/%{filename}"),
                css2: H("https://www.gstatic.com/charts/51/css/%{subdir1}/%{subdir2}/%{filename}"),
                third_party: H("https://www.gstatic.com/charts/51/third_party/%{subdir}/%{filename}"),
                third_party2: H("https://www.gstatic.com/charts/51/third_party/%{subdir1}/%{subdir2}/%{filename}"),
                third_party_gen: H("https://www.gstatic.com/charts/51/third_party/%{subdir}/%{filename}")
            },
            "gstatic.cn": {
                loader: H("https://www.gstatic.cn/charts/51/loader.js"),
                debug: H("https://www.gstatic.cn/charts/debug/51/js/jsapi_debug_%{package}_module.js"),
                debug_i18n: H("https://www.gstatic.cn/charts/debug/51/i18n/jsapi_debug_i18n_%{package}_module__%{language}.js"),
                compiled: H("https://www.gstatic.cn/charts/51/js/jsapi_compiled_%{package}_module.js"),
                compiled_i18n: H("https://www.gstatic.cn/charts/51/i18n/jsapi_compiled_i18n_%{package}_module__%{language}.js"),
                css: H("https://www.gstatic.cn/charts/51/css/%{subdir}/%{filename}"),
                css2: H("https://www.gstatic.cn/charts/51/css/%{subdir1}/%{subdir2}/%{filename}"),
                third_party: H("https://www.gstatic.cn/charts/51/third_party/%{subdir}/%{filename}"),
                third_party2: H("https://www.gstatic.cn/charts/51/third_party/%{subdir1}/%{subdir2}/%{filename}"),
                third_party_gen: H("https://www.gstatic.cn/charts/51/third_party/%{subdir}/%{filename}")
            }
        },
        ea: ["default"],
        qa: {
    ...
    */
    ...
    var Kc = H("https://ajax.googleapis.com/ajax/libs/%{module}/51/%{file}");
