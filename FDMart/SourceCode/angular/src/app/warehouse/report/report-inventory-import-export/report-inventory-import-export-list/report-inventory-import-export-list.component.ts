...
import { WMSReportService, WMS_Report_Inventory_Import_Export_ENTITY,  } from 'src/app/shared/service-proxies/api-shared';
  ...
  onClickAcction(id: number, storedName: string, param: string, keyService: string, classForm: string): void {
    switch(classForm){
      case EditPageState.add:{
        this.navigatePassParam('warehouse/inventory-import-export-add',[['code',this.idSelect]],new WMS_Report_Inventory_Import_Export_ENTITY({}),this.tbName)
        break;
      }
      case EditPageState.edit:{
        this.navigatePassParam('warehouse/inventory-import-export-edit',[['code',this.idSelect]],new WMS_Report_Inventory_Import_Export_ENTITY({}),this.tbName)
        break;
      }
