...
@Component({
  selector: 'app-calendar-month-view-detail',
  templateUrl: './calendar-month-view-detail.component.html',
  styleUrls: ['./calendar-month-view-detail.component.css']
})
export class CalendarMonthViewDetailComponent extends LayoutComponentBase implements OnInit, IUiAction<any> {
