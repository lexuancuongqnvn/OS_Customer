...
@Component({
  selector: 'app-report-of-accounts-receivable-balances-list',
  templateUrl: './report-of-accounts-receivable-balances-list.component.html',
  styleUrls: ['./report-of-accounts-receivable-balances-list.component.css']
})
export class ReportOfAccountsReceivableBalancesListComponent extends LayoutComponentBase implements OnInit, IUiAction<any> {
  ...
  onClickAcction(id: number, storedName: string, param: string, keyService: string, classForm: string): void {
    switch(classForm){
      case EditPageState.add:{
        this.navigatePassParam('sales/report-of-accounts-receivable-balances-add',[['code',this.idSelect]],new Sales_Report_Of_Accounts_Receivable_Balances_ENTITY({}),this.tbName)
        break;
      }
      case EditPageState.edit:{
        this.navigatePassParam('sales/report-of-accounts-receivable-balances-edit',[['code',this.idSelect]],new Sales_Report_Of_Accounts_Receivable_Balances_ENTITY({}),this.tbName)
        break;
      }
