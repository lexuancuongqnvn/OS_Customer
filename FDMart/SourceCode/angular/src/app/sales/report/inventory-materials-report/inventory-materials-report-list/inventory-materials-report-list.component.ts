...
export class InventoryMaterialsReportListComponent extends LayoutComponentBase implements OnInit, IUiAction<any> {
  ...
  onClickAcction(id: number, storedName: string, param: string, keyService: string, classForm: string): void {
    switch(classForm){
      case EditPageState.add:{
        this.navigatePassParam('sales/inventory-materials-report-add',[['code',this.idSelect]],new Sales_Report_Inventory_Materials_ENTITY({}),this.tbName)
        break;
      }
      case EditPageState.edit:{
        this.navigatePassParam('sales/inventory-materials-report-edit',[['code',this.idSelect]],new Sales_Report_Inventory_Materials_ENTITY({}),this.tbName)
        break;
      }
  ...
  onLoadData(){
    this.BlockUI();
    this.salesReportService.sales_Report_Inventory_Materials_Search({
      ...this.filterInput
