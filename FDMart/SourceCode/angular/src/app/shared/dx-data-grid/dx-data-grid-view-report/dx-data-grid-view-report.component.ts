...
export class DXDataGridViewReportComponent extends LayoutComponentBase implements OnInit {
  ...
  onChangeTypeFilterDate(e:any,rows:SYS_GenRowTable_Detail,colName:string){
    ...
    switch(e.value){
      ...
      break;
      case 5:
        this.filterDateFrom = moment().set('date',1).set('month',0).set('hour',0).set('minute',0).set('second',1)
        this.filterDateTo=  moment().set('date',31).set('month',4).set('hour',23).set('minute',23).set('second',0)
      break;
      case 6:
        this.filterDateFrom = moment().set('date',1).set('month',5).set('hour',0).set('minute',0).set('second',1)
        this.filterDateTo=  moment().set('date',31).set('month',11).set('hour',23).set('minute',23).set('second',0)
      break;
      case 7:
    ...
    this.OnChangeDataFilter.emit({colName:rows.columN_NAME+'_start',value:this.filterDateFrom,data:this.dataFilter})
    this.OnChangeDataFilter.emit({colName:rows.columN_NAME+'_end',value:this.filterDateTo,data:this.dataFilter})
  }
