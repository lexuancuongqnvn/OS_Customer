...
import { API_BASE_URL, PurchaseVoucherService, SalesCategoryService, SalesVATService, SalesVoucherService,OBPurchaseService } from "../shared/service-proxies/api-shared";
...
const drawerRoutes = [
    ...
    { path: 'purchase/beginning-balance-of-accounts-payable', component: ObAccountListComponent, data: {editPageState: EditPageState.view ,tbName:'OB_Account'} },
    { path: 'purchase/beginning-balance-of-accounts-payable-add', component: ObAccountEditComponent, data: {editPageState: EditPageState.add ,tbName:'OB_Account'} },
    { path: 'purchase/beginning-balance-of-accounts-payable-edit', component: ObAccountEditComponent, data: {editPageState: EditPageState.edit ,tbName:'OB_Account'} },
    { path: 'purchase/beginning-balance-of-accounts-payable-view-detail', component: ObAccountEditComponent, data: {editPageState: EditPageState.viewDetail ,tbName:'OB_Account'} },
