  ...
  async caculateSumMoney(){
    if (this.InputMaster.exchange_rate == 1){
      try{
        ...
        this.InputMaster.tax_money = Math.abs(this.InputMaster.accounting_VAT_Outputs.reduce((accumulator, currentObject) => {
      ...
      try{
        ...
        this.InputMaster.tax_money_fc = Math.abs(this.InputMaster.accounting_VAT_Outputs.reduce((accumulator, currentObject) => {
      ...
      this.InputMaster.tax_money = Math.abs(this.formatDefaultNumber(this.InputMaster.tax_money_fc * this.InputMaster.exchange_rate));
