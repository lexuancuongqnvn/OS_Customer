...
export class SalesStatisticsComponent extends LayoutComponentBase implements OnInit, IUiAction<any> {
  ...
  listData:HRM_Employee_Labour_Contract_Appendix_Target_Detail_ENTITY[] = [];
  rowSelected:HRM_Employee_Labour_Contract_Appendix_Target_Detail_ENTITY = new HRM_Employee_Labour_Contract_Appendix_Target_Detail_ENTITY();
