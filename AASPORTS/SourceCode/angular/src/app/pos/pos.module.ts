...
import { SalesManagementEditComponent } from './sale/sales-management/sales-management-edit/sales-management-edit.component';
...
const drawerRoutes = [
    ...
    { path: 'sales-management', component: SalesManagementComponent, data: {editPageState: EditPageState.edit ,tbName:'HRM_Employee_Labour_Contract_Appendix_Sales',voucher_code:''} },
    { path: 'sales-management-edit', component: SalesManagementEditComponent, data: {editPageState: EditPageState.edit ,tbName:'HRM_Employee_Labour_Contract_Appendix_Sales',voucher_code:''} },
    { path: 'sales-management-view-detail', component: SalesManagementEditComponent, data: {editPageState: EditPageState.edit ,tbName:'HRM_Employee_Labour_Contract_Appendix_Sales',voucher_code:''} },
