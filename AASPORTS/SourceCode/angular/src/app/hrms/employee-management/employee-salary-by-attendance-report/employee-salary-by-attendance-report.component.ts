...
@Component({
  selector: 'app-employee-salary-by-attendance-report',
  templateUrl: './employee-salary-by-attendance-report.component.html',
  styleUrls: ['./employee-salary-by-attendance-report.component.css']
})
export class EmployeeSalaryByAttendanceReportComponent  extends LayoutComponentBase implements OnInit, IUiAction<any> {
          ...
          this.table = `<table class="table table-bordered table-attendance-report">
                          <thead>
                              <tr>
                                  ...
                                  <th colspan="1" class="m-w-150" style="text-align: center;background-color: #000095;color: white;">Tổng lương thành tiền ngày công thực tế</th>
                              </tr>
                          </thead>
                          <tbody>
                            ${this.thead_th}
