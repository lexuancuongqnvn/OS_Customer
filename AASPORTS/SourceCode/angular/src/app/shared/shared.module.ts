...
import { CheckBlockBeforeLoginComponent } from './form/login/check-block-before-login/check-block-before-login.component';
import { StopAppComponent } from './form/login/stop-app/stop-app.component';
...
const drawerRoutes = [
    ...
    { path: 'stop-app', component: StopAppComponent },
];
...
@NgModule({
    declarations: [
        ...
        CheckBlockBeforeLoginComponent,
        StopAppComponent,
    ],
    imports: [
        BrowserModule,
