...
@Component({
  selector: 'osoft-data-grid-view-report-filter',
  templateUrl: './dx-data-grid-view-report-filter.component.html',
  styleUrls: ['./dx-data-grid-view-report-filter.component.css']
})
export class DxDataGridViewReportFilterComponent extends LayoutComponentBase implements OnInit {
  allMode: string;
