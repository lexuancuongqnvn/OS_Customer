...
@Component({
  selector: 'osoft-tree-list-report',
  templateUrl: './tree-list-report.component.html',
  styleUrls: ['./tree-list-report.component.css']
})
export class TreeListReportComponent  extends LayoutComponentBase implements OnInit {
  allMode: string;
