...
import { PermissionFeatureComponent } from './permission/permission-feature/permission-feature.component';
import { PermissionActionsComponent } from './permission/permission-actions/permission-actions.component';

const drawerRoutes = [
    { path: 'dashboard', component: DashboardHomeComponent },
    { path: 'acction', component: AcctionComponent },
    { path: 'system/action', component: AcctionComponent },
    ...
    { path: 'system/sys-report-infomation', component: ReportTemplateListComponent, data: {editPageState: EditPageState.view ,tbName:'SYS_Report_Infomation'} },
    { path: 'system/sys-report-infomation-add', component: ReportTemplateEditComponent, data: {editPageState: EditPageState.add ,tbName:'SYS_Report_Infomation'} },
    { path: 'system/sys-report-infomation-edit', component: ReportTemplateEditComponent, data: {editPageState: EditPageState.edit ,tbName:'SYS_Report_Infomation'} },
    ...
    { path: 'system/permission', component: PermissionComponent, data: {editPageState: EditPageState.view ,tbName:'SYS_Menu_Permission',voucher_code:''} },
    { path: 'system/permission-feature-edit', component: PermissionFeatureComponent, data: {editPageState: EditPageState.edit ,tbName:'SYS_Menu_Permission_Feature',voucher_code:''} },
    { path: 'system/permission-actions-edit', component: PermissionActionsComponent, data: {editPageState: EditPageState.edit ,tbName:'SYS_Menu_Permission_Actions',voucher_code:''} },
