...
import { PUR_Accounts_Payable_Report_By_Invoice_ENTITY, CashReportService, SalesReportService, OBPurchaseService, PurchaseReportService } from 'src/app/shared/service-proxies/api-shared';
import { EditPageState } from 'src/app/shared/ultilities/enum/edit-page-state';
import { IUiAction } from 'src/app/shared/ultilities/ui-action';

@Component({
  selector: 'app-accounts-payable-report-by-invoice',
  templateUrl: './accounts-payable-report-by-invoice.component.html',
  styleUrls: ['./accounts-payable-report-by-invoice.component.css']
})
export class AccountsPayableReportByInvoiceComponent extends LayoutComponentBase implements OnInit, IUiAction<any> {
  ...
  listData:PUR_Accounts_Payable_Report_By_Invoice_ENTITY[]=[];
  tbName:string = '';
  ...
  onClickAcction(id: number, storedName: string, param: string, keyService: string, classForm: string): void {
    switch(classForm){
      case EditPageState.add:{
        this.navigatePassParam('warehouse/opening-balance-input-output-inventory-add',[['code',this.idSelect]],new PUR_Accounts_Payable_Report_By_Invoice_ENTITY({}),this.tbName)
        break;
      }
      case EditPageState.edit:{
        this.navigatePassParam('warehouse/opening-balance-input-output-inventory-edit',[['code',this.idSelect]],new PUR_Accounts_Payable_Report_By_Invoice_ENTITY({}),this.tbName)
        break;
      }
  ...
  onLoadData(){
    ...
    this.purchaseReportService.pUR_Accounts_Payable_Report_By_Invoice_Search({
      ...this.filterInput
    } as PUR_Accounts_Payable_Report_By_Invoice_ENTITY).subscribe((res:PUR_Accounts_Payable_Report_By_Invoice_ENTITY[])=>{
      this.listData = res;
