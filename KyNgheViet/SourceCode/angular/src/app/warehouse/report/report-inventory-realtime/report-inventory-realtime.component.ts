...
@Component({
  selector: 'app-report-inventory-realtime',
  templateUrl: './report-inventory-realtime.component.html',
  styleUrls: ['./report-inventory-realtime.component.css']
})
export class ReportInventoryRealtimeComponent extends LayoutComponentBase implements OnInit, IUiAction<any> {
  ...
  onClickAcction(id: number, storedName: string, param: string, keyService: string, classForm: string): void {
    switch(classForm){
      case EditPageState.add:{
        this.navigatePassParam('warehouse/report-inventory-realtime-add',[['code',this.idSelect]],new WMS_Report_Inventory_ENTITY({}),this.tbName)
        break;
      }
      case EditPageState.edit:{
        this.navigatePassParam('warehouse/report-inventory-realtime-edit',[['code',this.idSelect]],new WMS_Report_Inventory_ENTITY({}),this.tbName)
        break;
      }
  ...
  onLoadData(){
    this.BlockUI();
    this.wMSReportService.wMS_Report_Inventory_Realtime_Have_Serial_Search({
      ...this.filterInput
