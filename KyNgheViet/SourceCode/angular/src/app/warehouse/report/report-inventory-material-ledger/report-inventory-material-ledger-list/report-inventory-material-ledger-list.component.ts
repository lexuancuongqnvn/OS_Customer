...
@Component({
  selector: 'app-report-inventory-material-ledger-list',
  templateUrl: './report-inventory-material-ledger-list.component.html',
  styleUrls: ['./report-inventory-material-ledger-list.component.css']
})
export class ReportInventoryMaterialLedgerListComponent extends LayoutComponentBase implements OnInit, IUiAction<any> {
  ...
  onClickAcction(id: number, storedName: string, param: string, keyService: string, classForm: string): void {
    switch(classForm){
      case EditPageState.add:{
        this.navigatePassParam('warehouse/inventory-material-ledger-add',[['code',this.idSelect]],new WMS_Report_Inventory_Material_Ledger_ENTITY({}),this.tbName)
        break;
      }
      case EditPageState.edit:{
        this.navigatePassParam('warehouse/inventory-material-ledger-edit',[['code',this.idSelect]],new WMS_Report_Inventory_Material_Ledger_ENTITY({}),this.tbName)
        break;
      }
  ...
  onLoadData(){
    this.BlockUI();
    this.wMSReportService.wMS_Report_Inventory_Material_Ledger_Search({
      ...this.filterInput
    } as WMS_Report_Inventory_Material_Ledger_ENTITY).subscribe((res:WMS_Report_Inventory_Material_Ledger_ENTITY[])=>{
      this.listData = res;
