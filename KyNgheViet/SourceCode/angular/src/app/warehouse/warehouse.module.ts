...
import { ReportCalculateTheAverageCostingListComponent } from './report/report-calculate-the-average-costing/report-calculate-the-average-costing-list/report-calculate-the-average-costing-list.component';
import { CostingOfInventoryComponent } from './voucher/costing-of-inventory/costing-of-inventory.component';
import { ReportInventoryRealtimeComponent } from './report/report-inventory-realtime/report-inventory-realtime.component';
import { InventoryMaterialsReportListComponent } from '../sales/report/inventory-materials-report/inventory-materials-report-list/inventory-materials-report-list.component';
import { GoodsCongfigurationComponent } from './category/goods/goods-congfiguration/goods-congfiguration.component';
import { GoodsCongfigurationListComponent } from './category/goods/goods-congfiguration-list/goods-congfiguration-list.component';
...
const drawerRoutes = [
    ...
    { path: 'warehouse/costing-of-inventory', component: CostingOfInventoryComponent, data: {editPageState: EditPageState.view ,tbName:'WMS_Calculate_The_Average_Costing_Search'} },
    ...
    { path: 'warehouse/goods-update-configuration', component: GoodsCongfigurationComponent, data: {editPageState: EditPageState.edit ,tbName:'CAT_Goods_Configuration_Update' } },
    { path: 'warehouse/goods-configuration', component: GoodsCongfigurationListComponent, data: {editPageState: EditPageState.view ,tbName:'CAT_Goods_Configuration_Update' } },
    ...
    { path: 'warehouse/inventory-issue-report', component: ReportI43ListComponent, data: {editPageState: EditPageState.view ,tbName:'WMS_Report_I43_Search',voucher_code:'PXK'} },
    ...
    { path: 'warehouse/report-calculate-the-average-costing', component: ReportCalculateTheAverageCostingListComponent, data: {editPageState: EditPageState.view ,tbName:'WMS_Report_Calculate_The_Average_Costing_Search'} },
    { path: 'warehouse/report-inventory-realtime', component: ReportInventoryRealtimeComponent, data: {editPageState: EditPageState.view ,tbName:'WMS_Report_Inventory_Realtime_Search'} },
...
@NgModule({
    declarations: [
        ...
        ReportCalculateTheAverageCostingListComponent,
        CostingOfInventoryComponent,
        ReportInventoryRealtimeComponent,
        InventoryMaterialsReportListComponent,
        GoodsCongfigurationComponent,
        GoodsCongfigurationListComponent
    ],
    imports: [
        BrowserModule,
        AppRoutingModule,
