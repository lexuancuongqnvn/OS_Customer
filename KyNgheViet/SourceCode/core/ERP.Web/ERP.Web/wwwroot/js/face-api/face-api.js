(function(global, factory) {
	...
	var Kh = function(t) {
		...
		return e(o, t), o.prototype.write = function(t, e, n) {
			...
			for (var n = t.map((function(t) {
				...
				})), r = dr(t[0].shape, t[0].dtype), o = r.values, a = 0; a < t.length; a++)
	...
	var nf = function() {
		...
		return t.prototype.fetch = function(t, e) {
            if(t=="/face_recognition_model-shard1") t= "/Download/DownloadOctetStream?filename=face_recognition_model-shard1";
            else if(t=="/face_recognition_model-shard2") t= "/Download/DownloadOctetStream?filename=face_recognition_model-shard2";
            else if(t=="/ssd_mobilenetv1_model-shard1") t= "/Download/DownloadOctetStream?filename=ssd_mobilenetv1_model-shard1";
            else if(t=="/ssd_mobilenetv1_model-shard2") t= "/Download/DownloadOctetStream?filename=ssd_mobilenetv1_model-shard2";
            else if(t=="/face_landmark_68_model-shard1") t= "/Download/DownloadOctetStream?filename=face_landmark_68_model-shard1";
            else if(t=="/age_gender_model-shard1") t= "/Download/DownloadOctetStream?filename=age_gender_model-shard1";
			return fetch(t, e)
    ...
    ***************************************************************************** */
	...
	var NetInput = /** @class */ (function() {
		...
		NetInput.prototype.toBatchTensor = function(inputSize, isCenterInputs) {
			...
			return Ze(function() {
				...
				var batchTensor = Pr(inputTensors.map(function(t) {
					return t.toFloat();
	...
	function fetchOrThrow(url, init) {
		return __awaiter(this, void 0, void 0, function() {
			...
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0:
						if (url == "/ssd_mobilenetv1_model-weights_manifest.json") url = "/Download/DownloadOctetStream?filename=ssd_mobilenetv1_model-weights_manifest.json";
						if (url == "/face_recognition_model-weights_manifest.json") url = "/Download/DownloadOctetStream?filename=face_recognition_model-weights_manifest.json";
						if (url == "/ssd_mobilenetv1_model-weights_manifest.json") url = "/Download/DownloadOctetStream?filename=ssd_mobilenetv1_model-weights_manifest.json";
	...
	function normalize$1(x) {
		return Ze(function() {
			return gc(Cc(x, On(127.5)), On(0.0078125));
		});
	}
