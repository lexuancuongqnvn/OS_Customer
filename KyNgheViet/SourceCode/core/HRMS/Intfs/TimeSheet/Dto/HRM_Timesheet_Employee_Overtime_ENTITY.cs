...
{
    public class HRM_Timesheet_Employee_Overtime_ENTITY
    {
        public int ID { get; set; }
        public string code { get; set; }
        public string checker { get; set; }
        public string checker_name { get; set; }
        public string work_land { get; set; }
        public string work_land_name { get; set; }
        ...
        public DateTime? start_relax_datetime { get; set; }
        public string start_datetime_f { get; set; }
        public string start_relax_datetime_f { get; set; }
        public string approve_note { get; set; }
        public string start_datetime_f_en { get; set; }
        public DateTime? end_datetime { get; set; }
        public DateTime? end_relax_datetime { get; set; }
        public string end_datetime_f { get; set; }
        public string end_relax_datetime_f { get; set; }
        ...
        public int? max_day_number { get; set; }
