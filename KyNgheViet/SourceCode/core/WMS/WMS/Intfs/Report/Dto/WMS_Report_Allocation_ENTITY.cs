...
{
    public class WMS_Report_Allocation_ENTITY : IBase_ENTITY
    {
        ...
        public decimal? quantity_of_damaged_items_on_hand   {get;set;}
        ...
        public string fee_sumbol  {get;set;}
        public string case_code {get;set;}
        public string case_symbol {get;set;}
        public decimal? allocation_period {get;set;}
        public int? period_number {get;set;}
        public int? amortization_Expense_for_the_period {get;set;}
        public decimal? allocated_money {get;set;}
        public int? remaining_funds {get;set;}
